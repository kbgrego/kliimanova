...
export class TranslationService {
  private readonly translations: Record<SupportedLanguage, Record<string, string>> = {
    en: {
      ...
      'hero.subtitle': 'Heating, cooling and ventilation solutions designed for modern homes and businesses.',
      'hero.services.cooling': 'Cooling',
      'hero.services.heating': 'Heating',
      'hero.services.heatPumps': 'Heat Pumps',
      'hero.services.service': 'Service',
    ...
    et: {
      ...
      'nav.consultation': 'Konsultatsioon',
      'nav.prices': 'Hinnad',
      'nav.cooling': 'Jahutus',
      'nav.heating': 'Küte',
      'nav.heating-pumps': 'Soojuspumbad',
    ...
    ru: {
      ...
      'nav.cooling': 'Охлаждение',
      'nav.heating': 'Отопление',
      'nav.heating-pumps': 'Тепловые насосы',
